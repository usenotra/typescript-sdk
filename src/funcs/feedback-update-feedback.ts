...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UpdateFeedbackRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/feedback/{feedbackId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FeedbackResponse$inboundSchema),

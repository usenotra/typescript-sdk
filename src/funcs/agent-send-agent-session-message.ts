 ...
 */
export function agentSendAgentSessionMessage(
  client: NotraCore,
  request: operations.SendAgentSessionMessageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SendAgentSessionMessageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SendAgentSessionMessageRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v2/eve/v1/session/{sessionId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SendAgentSessionMessageResponse$inboundSchema, {
      key: "Result",
    }),

 ...
 */
export function geoRotateGEOIngestToken(
  client: NotraCore,
  request?: operations.RotateGeoIngestTokenRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoIngestTokenResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.RotateGeoIngestTokenRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v1/geo/ingest/rotate-token")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoIngestTokenResponse$inboundSchema),
    M.jsonErr(

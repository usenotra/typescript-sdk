 ...
 */
export function geoGetGEOAgentReadiness(
  client: NotraCore,
  request: operations.GetGeoAgentReadinessRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoAgentReadinessResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoAgentReadinessRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/agent-readiness")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoAgentReadinessResponse$inboundSchema),
    M.jsonErr(

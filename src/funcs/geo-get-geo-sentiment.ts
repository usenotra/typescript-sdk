 ...
 */
export function geoGetGEOSentiment(
  client: NotraCore,
  request: operations.GetGeoSentimentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoSentimentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetGeoSentimentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/sentiment")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoSentimentResponse$inboundSchema),
    M.jsonErr(

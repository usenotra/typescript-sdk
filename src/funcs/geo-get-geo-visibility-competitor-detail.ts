 ...
 */
export function geoGetGEOVisibilityCompetitorDetail(
  client: NotraCore,
  request: operations.GetGeoVisibilityCompetitorDetailRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityCompetitorDetailResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetGeoVisibilityCompetitorDetailRequest$outboundSchema,
        value,
      ),
  ...
  const pathParams = {
    brand: encodeSimple("brand", payload.brand, {
      explode: false,
  ...
  const path = pathToFunc(
    "/v1/projects/{projectId}/geo/visibility/competitors/{brand}",
  )(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoVisibilityCompetitorDetailResponse$inboundSchema),
    M.jsonErr(

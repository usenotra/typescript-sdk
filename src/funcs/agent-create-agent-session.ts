 ...
 */
export function agentCreateAgentSession(
  client: NotraCore,
  request: models.CreateAgentSessionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateAgentSessionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateAgentSessionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v2/eve/v1/session")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateAgentSessionResponse$inboundSchema, {
      key: "Result",
    }),
    ...
    M.jsonErr([500, 502, 503], errors.ErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),

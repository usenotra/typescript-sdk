 ...
 */
export function geoUpsertGEOCompetitor(
  client: NotraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpsertGeoCompetitorRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/competitors")(
    pathParams,
  );

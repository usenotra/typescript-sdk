...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PatchSkillRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/skills/{name}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PatchSkillResponse$inboundSchema),

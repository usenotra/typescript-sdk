 ...
 */
export function geoListGEOPromptResultSummaries(
  client: NotraCore,
  request: operations.ListGeoPromptResultSummariesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityPromptResultSummariesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListGeoPromptResultSummariesRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/v1/projects/{projectId}/geo/visibility/prompt-results/summaries",
  )(pathParams);
  ...
  >(
    M.json(
      200,
      models.GeoVisibilityPromptResultSummariesResponse$inboundSchema,
    ),
    M.jsonErr(

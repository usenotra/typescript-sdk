 ...
 */
export function geoGetGEOVisibilityLanguageShare(
  client: NotraCore,
  request: operations.GetGeoVisibilityLanguageShareRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityLanguageShareResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetGeoVisibilityLanguageShareRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoVisibilityLanguageShareResponse$inboundSchema),
    M.jsonErr(

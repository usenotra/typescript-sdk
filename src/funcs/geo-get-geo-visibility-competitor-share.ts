 ...
 */
export function geoGetGEOVisibilityCompetitorShare(
  client: NotraCore,
  request: operations.GetGeoVisibilityCompetitorShareRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityCompetitorShareResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetGeoVisibilityCompetitorShareRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoVisibilityCompetitorShareResponse$inboundSchema),
    M.jsonErr(

 ...
 */
export function geoGetGEOVisibilityOverview(
  client: NotraCore,
  request: operations.GetGeoVisibilityOverviewRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityOverviewResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoVisibilityOverviewRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/visibility/overview")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoVisibilityOverviewResponse$inboundSchema),
    M.jsonErr(

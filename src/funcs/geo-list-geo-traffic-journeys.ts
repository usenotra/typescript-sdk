 ...
 */
export function geoListGEOTrafficJourneys(
  client: NotraCore,
  request: operations.ListGeoTrafficJourneysRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoTrafficJourneysResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListGeoTrafficJourneysRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/traffic/journeys")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoTrafficJourneysResponse$inboundSchema),
    M.jsonErr(

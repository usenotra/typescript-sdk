...
export function contentCreateBrandIdentity(
  ...
  Result<
    operations.CreateBrandIdentityResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateBrandIdentityRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/brand-identities/generate")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.CreateBrandIdentityResponse$inboundSchema, {
      key: "Result",
    }),

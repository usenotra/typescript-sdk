 ...
 */
export function geoListGEOContentGaps(
  client: NotraCore,
  request: operations.ListGeoContentGapsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoContentGapsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListGeoContentGapsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/gaps")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoContentGapsResponse$inboundSchema),
    M.jsonErr(

 ...
 */
export function geoGetGEOSentimentAnalysis(
  client: NotraCore,
  request: operations.GetGeoSentimentAnalysisRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoSentimentAnalysisResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoSentimentAnalysisRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/sentiment/analysis")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoSentimentAnalysisResponse$inboundSchema),
    M.jsonErr(

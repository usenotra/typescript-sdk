 ...
 */
export function geoUpdateProject(
  client: NotraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UpdateProjectRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoProjectResponse$inboundSchema),
    M.jsonErr(

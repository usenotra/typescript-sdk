 ...
 */
export function discoveryGetWorkspaces(
  client: NotraCore,
  request?: operations.GetWorkspacesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GetWorkspacesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetWorkspacesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v1/me/workspaces")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetWorkspacesResponse$inboundSchema),

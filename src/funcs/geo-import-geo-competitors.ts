...
export function geoImportGEOCompetitors(
  ...
  Result<
    operations.ImportGeoCompetitorsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ImportGeoCompetitorsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/competitors/import")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ImportGeoCompetitorsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(

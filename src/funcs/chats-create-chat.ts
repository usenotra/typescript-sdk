...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.SendChatMessageRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/chats")();
  ...
  >(
    ...
    M.json(202, operations.CreateChatResponse$inboundSchema),

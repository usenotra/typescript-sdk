 ...
 */
export function geoCreateGEOScan(
  client: NotraCore,
  request: operations.CreateGeoScanRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateGeoScanResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CreateGeoScanRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/scans")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.CreateGeoScanResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(

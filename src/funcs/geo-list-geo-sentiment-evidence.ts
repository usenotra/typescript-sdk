 ...
 */
export function geoListGEOSentimentEvidence(
  client: NotraCore,
  request: operations.ListGeoSentimentEvidenceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoSentimentEvidenceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListGeoSentimentEvidenceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/sentiment/evidence")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoSentimentEvidenceResponse$inboundSchema),
    M.jsonErr(

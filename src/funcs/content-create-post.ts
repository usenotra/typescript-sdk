 ...
 */
export function contentCreatePost(
  client: NotraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CreatePostRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreatePostResponse$inboundSchema, { key: "Result" }),

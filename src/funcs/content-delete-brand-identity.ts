 ...
 */
export function contentDeleteBrandIdentity(
  client: NotraCore,
  request: operations.DeleteBrandIdentityRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteBrandIdentityResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteBrandIdentityRequest$outboundSchema, value),
  ...
  const pathParams = {
    brandIdentityId: encodeSimple("brandIdentityId", payload.brandIdentityId, {
      explode: false,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteBrandIdentityResponse$inboundSchema),

...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(models.CreateSkillRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/v1/skills")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CreateSkillResponse$inboundSchema),

 ...
 */
export function geoGetGEOVisibilityPromptResults(
  client: NotraCore,
  request: operations.GetGeoVisibilityPromptResultsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityPromptResultsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetGeoVisibilityPromptResultsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoVisibilityPromptResultsResponse$inboundSchema),
    M.jsonErr(

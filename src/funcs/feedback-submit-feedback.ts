 ...
 */
export function feedbackSubmitFeedback(
  client: NotraCore,
  request: models.SubmitFeedbackRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SubmitFeedbackResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.SubmitFeedbackRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.SubmitFeedbackResponse$inboundSchema, {
      key: "Result",
    }),

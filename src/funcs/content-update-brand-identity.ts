 ...
 */
export function contentUpdateBrandIdentity(
  client: NotraCore,
  request: operations.UpdateBrandIdentityRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateBrandIdentityResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateBrandIdentityRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateBrandIdentityResponse$inboundSchema),

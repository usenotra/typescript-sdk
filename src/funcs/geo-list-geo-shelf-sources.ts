 ...
 */
export function geoListGEOShelfSources(
  client: NotraCore,
  request: operations.ListGeoShelfSourcesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoShelfListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListGeoShelfSourcesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/shelf-sources")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoShelfListResponse$inboundSchema),
    M.jsonErr(

...
export function contentGetBrandIdentityGeneration(
  ...
  Result<
    operations.GetBrandIdentityGenerationResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetBrandIdentityGenerationRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/brand-identities/generate/{jobId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBrandIdentityGenerationResponse$inboundSchema),

 ...
 */
export function eventTriggersDeleteEventTrigger(
  client: NotraCore,
  request: operations.DeleteEventTriggerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteEventTriggerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteEventTriggerRequest$outboundSchema, value),

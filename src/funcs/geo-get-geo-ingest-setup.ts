 ...
 */
export function geoGetGEOIngestSetup(
  client: NotraCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoIngestSetupResponse,
...
> {
  const path = pathToFunc("/v1/geo/ingest/setup")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoIngestSetupResponse$inboundSchema),
    M.jsonErr(

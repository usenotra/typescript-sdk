...
export function geoRunGEOSequence(
  ...
  Result<
    operations.RunGeoSequenceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.RunGeoSequenceRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/v1/projects/{projectId}/geo/sequences/{sequenceId}/run",
  )(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RunGeoSequenceResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(

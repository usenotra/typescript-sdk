 ...
 */
export function geoIssueGEOIngestToken(
  client: NotraCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.IssueGeoIngestTokenRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v1/geo/ingest/token")();

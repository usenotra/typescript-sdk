 ...
 * List GEO scans
 */
export function geoListGEOScans(
  client: NotraCore,
  request: operations.ListGeoScansRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ListGeoScansResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ListGeoScansRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListGeoScansResponse$inboundSchema),
    M.jsonErr(

 ...
 */
export function geoGetGEOTrafficOverview(
  client: NotraCore,
  request: operations.GetGeoTrafficOverviewRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoTrafficOverviewResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoTrafficOverviewRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/traffic/overview")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoTrafficOverviewResponse$inboundSchema),
    M.jsonErr(

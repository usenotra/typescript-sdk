 ...
 */
export function geoImportGEOPrompts(
  client: NotraCore,
  request: operations.ImportGeoPromptsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ImportGeoPromptsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ImportGeoPromptsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/prompts/import")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ImportGeoPromptsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(

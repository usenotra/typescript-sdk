 ...
 */
export function geoUpdateGEOSettings(
  client: NotraCore,
  request: operations.UpdateGeoSettingsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoSettingsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateGeoSettingsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/settings")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoSettingsResponse$inboundSchema),
    M.jsonErr(

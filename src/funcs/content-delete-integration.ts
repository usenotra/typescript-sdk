...
export function contentDeleteIntegration(
  ...
  Result<
    operations.DeleteIntegrationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteIntegrationRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteIntegrationResponse$inboundSchema),

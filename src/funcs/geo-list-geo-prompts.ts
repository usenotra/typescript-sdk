 ...
 */
export function geoListGEOPrompts(
  client: NotraCore,
  request: operations.ListGeoPromptsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ListGeoPromptsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ListGeoPromptsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/prompts")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListGeoPromptsResponse$inboundSchema),
    M.jsonErr(

 ...
 */
export function geoListGEOChanges(
  client: NotraCore,
  request: operations.ListGeoChangesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoChangesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ListGeoChangesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/changes")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoChangesResponse$inboundSchema),
    M.jsonErr(

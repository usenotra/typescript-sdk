 ...
 * List agent sessions
 */
export function agentListAgentChats(
  client: NotraCore,
  request?: operations.ListAgentChatsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListAgentChatsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListAgentChatsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v2/agent-chats")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAgentChatsResponse$inboundSchema, {
      key: "Result",
    }),

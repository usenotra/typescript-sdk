 ...
 */
export function geoSuggestGEOCompetitors(
  client: NotraCore,
  request: operations.SuggestGeoCompetitorsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SuggestGeoCompetitorsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SuggestGeoCompetitorsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SuggestGeoCompetitorsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(

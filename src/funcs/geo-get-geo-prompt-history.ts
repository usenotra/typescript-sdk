 ...
 */
export function geoGetGEOPromptHistory(
  client: NotraCore,
  request: operations.GetGeoPromptHistoryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoPromptHistoryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoPromptHistoryRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/v1/projects/{projectId}/geo/prompts/{promptId}/history",
  )(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoPromptHistoryResponse$inboundSchema),
    M.jsonErr(

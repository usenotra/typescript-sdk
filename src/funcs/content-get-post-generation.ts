...
export function contentGetPostGeneration(
  ...
  Result<
    operations.GetPostGenerationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetPostGenerationRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/posts/generate/{jobId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPostGenerationResponse$inboundSchema),

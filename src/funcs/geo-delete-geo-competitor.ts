 ...
 */
export function geoDeleteGEOCompetitor(
  client: NotraCore,
  request: operations.DeleteGeoCompetitorRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ListGeoCompetitorsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteGeoCompetitorRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/competitors/{name}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListGeoCompetitorsResponse$inboundSchema),
    M.jsonErr(

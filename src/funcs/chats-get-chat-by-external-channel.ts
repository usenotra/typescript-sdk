...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetChatByExternalChannelRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/chats/by-external")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ChatSessionSummary$inboundSchema),

...
export function contentGetBrandIdentity(
  ...
  Result<
    operations.GetBrandIdentityResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetBrandIdentityRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBrandIdentityResponse$inboundSchema),

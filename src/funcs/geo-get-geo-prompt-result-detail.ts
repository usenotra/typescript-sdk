 ...
 */
export function geoGetGEOPromptResultDetail(
  client: NotraCore,
  request: operations.GetGeoPromptResultDetailRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GeoVisibilityPromptResultDetailResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoPromptResultDetailRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/v1/projects/{projectId}/geo/visibility/prompt-results/{checkId}",
  )(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoVisibilityPromptResultDetailResponse$inboundSchema),
    M.jsonErr(

...
export function geoListGEOTrafficPages(
  ...
  Result<
    models.GeoTrafficPagesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListGeoTrafficPagesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/traffic/pages")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoTrafficPagesResponse$inboundSchema),
    M.jsonErr(

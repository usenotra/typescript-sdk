...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetGeoTrafficLogRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/geo/traffic/log")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GeoTrafficLogResponse$inboundSchema),
    M.jsonErr(

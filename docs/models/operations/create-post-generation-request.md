...
| -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `contentType`                                                                                                                    | [operations.CreatePostGenerationContentTypeRequest](../../models/operations/create-post-generation-content-type-request.md)      | :heavy_check_mark:                                                                                                               | Type of content to generate.                                                                                                     | blog_post                                                                                                                        |
...
| `timezone`                                                                                                                       | *string*                                                                                                                         | :heavy_minus_sign:                                                                                                               | IANA timezone used for relative lookback windows such as current_day and yesterday.                                              | America/New_York                                                                                                                 |
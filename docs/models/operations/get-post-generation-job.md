...
| `status`                                                                                                     | [operations.GetPostGenerationStatus](../../models/operations/get-post-generation-status.md)                  | :heavy_check_mark:                                                                                           | Job state. Terminal states are completed, failed, and skipped.                                               |
...
| `postId`                                                                                                     | *string*                                                                                                     | :heavy_check_mark:                                                                                           | ID of the generated post. Set once the job reaches completed.                                                |
| `error`                                                                                                      | *string*                                                                                                     | :heavy_check_mark:                                                                                           | Failure reason when status is failed.                                                                        |

...
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `status`                                                                                        | [models.PublicStatusResponseStatus](../models/public-status-response-status.md)                 | :heavy_check_mark:                                                                              | N/A                                                                                             |
| `service`                                                                                       | [models.Service](../models/service.md)                                                          | :heavy_check_mark:                                                                              | N/A                                                                                             |
| `version`                                                                                       | *string*                                                                                        | :heavy_check_mark:                                                                              | N/A                                                                                             |
| `public`                                                                                        | *true*                                                                                          | :heavy_check_mark:                                                                              | N/A                                                                                             |
| `authentication`                                                                                | [models.PublicStatusResponseAuthentication](../models/public-status-response-authentication.md) | :heavy_check_mark:                                                                              | N/A                                                                                             |
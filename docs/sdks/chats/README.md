...
* [getChatByExternalChannel](#getchatbyexternalchannel) - Get a chat by external channel id
...
<!-- UsageSnippet language="typescript" operationID="getChatByExternalChannel" method="get" path="/v1/chats/by-external" -->
```typescript
import { Notra } from "@usenotra/sdk";
...
async function run() {
  const result = await notra.chats.getChatByExternalChannel({
    source: "discord",
    id: "channel_123",
  });
...
```typescript
import { NotraCore } from "@usenotra/sdk/core.js";
import { chatsGetChatByExternalChannel } from "@usenotra/sdk/funcs/chats-get-chat-by-external-channel.js";
...
async function run() {
  const res = await chatsGetChatByExternalChannel(notra, {
    source: "discord",
    id: "channel_123",
  });
  if (res.ok) {
    ...
    console.log("chatsGetChatByExternalChannel failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetChatByExternalChannelRequest](../../models/operations/get-chat-by-external-channel-request.md)                                                                  | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.ChatSessionSummary](../../models/chat-session-summary.md)\>**
